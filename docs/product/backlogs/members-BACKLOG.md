...
- **Iteration 2:** constrain Hero OTP row (`max-w-md` / `max-w-xl` with code) so it doesn’t stretch under Sub/Join; vertically center hero copy in the sticky image frame (nav clearance).
