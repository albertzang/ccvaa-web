...
- **Iteration 3 (CEO):** Drop info banners; client validation → red input outline; unified dismissible nav chip. Logged-in banner minimum: email send/verify, newsletter toggle, checkout, join-return (not logout / profile load / unsub invalid / plans-load).
