...
- **Iteration 2:** constrain Hero OTP row; center logged-out hero in image frame; **verified = compact hero** (smaller type, tight spacing, under nav) so `#membership` owns the sticky frame.
