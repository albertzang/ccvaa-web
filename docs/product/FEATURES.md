...
| 2026-07-12 | **agent-os-0005:** PM chat title `Product Manager`; ephemeral fixed-name handoffs/reports under `docs/handoffs` + `docs/reports`; backlog items ID descending |
