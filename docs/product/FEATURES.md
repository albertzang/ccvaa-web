...
| 2026-07-12 | **agent-os-0005:** PM chat title `Product Manager`; ephemeral handoffs/reports under `docs/handoffs` + `docs/reports` (removed `docs/qa`); backlog items ID descending |
