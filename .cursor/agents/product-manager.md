...
5. **Prompt CEO** at each gate using `docs/protocols/CEO.md` (kick Pass 1, approve merge, kick Pass 2, secrets, OTP paste)
6. After ships: update FEATURES.md / ROADMAP.md; CEO may manually check `ccvaa.ca`
7. Propose OS improvements; wait for CEO approval before large process changes
